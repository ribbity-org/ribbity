...
[IssuePrefix: test `other` things!](6-test-other-things.md)



[IssuePrefix: test issue number 1](1-test-issue-number-1.md)
...
[IssuePrefix: what happens with external links?](8-what-happens-with-external-links.md)
